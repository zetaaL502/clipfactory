        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="space-y-1.5">
            <label className="flex items-center gap-1.5 text-xs font-semibold text-zinc-400 uppercase tracking-wider">
              <Clock className="w-3.5 h-3.5" /> Clip Duration <span className="normal-case font-normal text-zinc-600">(global default for all clips)</span>
            </label>
            <input
              type="text"
              list="duration-suggestions"
            ...
            <p className="text-[11px] text-zinc-600 leading-relaxed max-w-xs">
              To override duration for a single clip, tap the <span className="font-mono text-zinc-400 bg-zinc-800 px-1 rounded">30s</span> badge on any thumbnail in the grid below.
            </p>
